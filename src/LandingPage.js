...
<section className="py-20">
  ...
  <div className="max-w-2xl mx-auto">
    ...
    <div className="relative group">
      <img
        src="img.jpg"
        alt="Professional resume sample created with ResuCraft"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="surface rounded-lg p-8 text-center">
              ...
              <blockquote className="text-lg italic mb-4" style={{ color: 'var(--color-foreground)' }}>
                "ResuCraft helped me land my dream job! The LaTeX formatting made my resume look incredibly professional."
              </blockquote>
